...
pub(crate) const DEFAULT_AGGREGATE_API_PROBE_INTERVAL_SECS: u64 = 180;
pub(crate) const DEFAULT_USAGE_POLL_JITTER_SECS: u64 = 5;
pub(crate) const DEFAULT_GATEWAY_KEEPALIVE_JITTER_SECS: u64 = 5;
pub(crate) const DEFAULT_AGGREGATE_API_PROBE_JITTER_SECS: u64 = 5;
...
pub(crate) const DEFAULT_AGGREGATE_API_PROBE_FAILURE_BACKOFF_MAX_SECS: u64 = 900;
pub(crate) const MIN_USAGE_POLL_INTERVAL_SECS: u64 = 30;
pub(crate) const MIN_GATEWAY_KEEPALIVE_INTERVAL_SECS: u64 = 30;
pub(crate) const MIN_AGGREGATE_API_PROBE_INTERVAL_SECS: u64 = 30;
